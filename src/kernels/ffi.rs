...
extern "C" {
  ...
  pub fn neuralops_avgpool2d_bwd(
      ...
      pool_w: usize,
      pool_h: usize);
  pub fn neuralops_caffe_maxpool2d_fwd(
      batch_sz: usize,
      in_width: usize,
      in_height: usize,
      chan: usize,
      ...
      pad_w: usize,
      pad_h: usize);
  pub fn neuralops_caffe_maxpool2d_bwd(
      batch_sz: usize,
      in_width: usize,
      in_height: usize,
      chan: usize,
...
extern "C" {
  ...
  pub fn neuralops_omp_caffe_avgpool2d_bwd(
      ...
      pad_w: usize,
      pad_h: usize);
  pub fn neuralops_omp_caffe_maxpool2d_fwd(
      batch_sz: usize,
      in_width: usize,
      in_height: usize,
      chan: usize,
      ...
      pad_w: usize,
      pad_h: usize);
  pub fn neuralops_omp_caffe_maxpool2d_bwd(
      batch_sz: usize,
      in_width: usize,
      in_height: usize,
      chan: usize,
